      ...
      builder: (context, _) {
        ...
        final Map<String, Widget> cardWidgets = {
          'buddy': DashboardButton(
            ...
            connectivityBadge: TranslationService.translate('badge_hybrid', lang),
            isOnline: true,
          ...
          'easylens': DashboardButton(
            ...
            connectivityBadge: TranslationService.translate('badge_offline', lang),
            isOnline: false,
          ...
          'sos': DashboardButton(
            ...
            connectivityBadge: TranslationService.translate('badge_sms_only', lang),
            isOnline: false,
