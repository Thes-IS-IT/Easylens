...
* **Role**: Acts as a zero-installation alternative during developer testing so developers can test RAG workflows using Gemma without manually loading the binary into mobile storage.
