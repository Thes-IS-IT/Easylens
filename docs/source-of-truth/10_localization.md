...
EasyLens uses a unified local translation model based on statically mapped key-value lookups, rather than relying on external packages. This ensures zero-latency page builds and offline compatibility.

### Translation Service
The translation engine is managed by [translation_service.dart](file:///Users/arronkianparejas/easylens/lib/services/translation_service.dart).
...
### Step 3: Register in TTS Service Language Code Map
...
### Step 4: Add to Settings Selection Lists
